...
// ─── Loan Detail Page Links ───────────────────────────────────────────────────

const loanHrefs: Record<LoanKey, string> = {
  ...
  heloc: '/loans/heloc',
  dscr: '/loans/dscr',
  bankStatement: '/loans/bank-statement',
  bridge: '/loans/bridge-construction',
  doctorLoan: '/loans/doctor-loan',
}
              ...
              <div className="space-y-3">
                {currentQ.options.map((opt) => (
                  <button
                    ...
                    className="card-white w-full text-left border border-[#E5E5E5] bg-white px-6 py-5 rounded-2xl hover:border-[#999999] hover:bg-[#F5F5F5] transition-all group"
                  >
          ...
          {done && topLoans.length === 2 && (
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                {topLoans.map((key, i) => {
                  ...
                  return (
                    <div
                      key={key}
                      className="card-white bg-white border border-[#E5E5E5] rounded-2xl px-7 py-8"
                    ...
                    >
                      ...
                      <p className="text-[#888888] text-sm leading-relaxed border-t border-[#E5E5E5] pt-5 mb-4">
              ...
              <div className="border border-[#E5E5E5] bg-white rounded-2xl px-8 py-10 text-center">
                ...
                <p className="text-[#555555] text-sm leading-relaxed mb-8 max-w-md mx-auto">
                ...
                <button
                  onClick={openModal}
                  className="bg-[#0A0A0A] text-[#F8F8F8] px-8 py-3.5 text-sm tracking-wide rounded-full hover:bg-[#333333] transition-colors"
                >
                  Set Up a Free Call
                </button>
              </div>
