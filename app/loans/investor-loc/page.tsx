...
export const metadata: Metadata = {
  ...
  description:
    'Revolving lines of credit for real estate investors in Fort Collins, Greeley, Loveland, Timnath, Windsor, and Severance. Access capital for acquisitions, renovations, and deal flow without refinancing. NMLS# 2845865',
  openGraph: {
    title: 'Investor Line of Credit | Northern Colorado Real Estate | Stevie de Gala',
    description:
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    {
      '@type': 'Question',
      name: 'How much can I access with an investor line of credit?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Credit limits depend on the equity in your portfolio, the cash flow of your properties, your credit profile, and lender guidelines. I structure the facility to maximize available capital based on your specific asset base. Lines for investors in Northern Colorado typically range from $100,000 to several million depending on portfolio size.',
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Investor lines of credit are most common among active real estate investors with existing portfolios — BRRRR investors, fix-and-flip operators scaling to rental holds, and physicians or professionals who use real estate as a wealth-building vehicle alongside their career income. Windsor, Severance, Timnath, and the broader Weld and Larimer County markets offer good opportunities for this strategy given the active new construction and rental demand in the area.',
      },
    },
  ],
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Investor Line of Credit', item: 'https://mortgagestevie.com/loans/investor-loc' },
  ],
}

export default function InvestorLOCPage() {
  return (
    <main className="pt-16 md:pt-20">
      ...
      <section className="bg-[#0A0A0A] py-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-[#C4C4C4] leading-relaxed mb-12 max-w-2xl">
            Every real estate investor's situation is different — but most of the use cases fall into one of these categories.
          </p>
          <div className="grid md:grid-cols-2 gap-6">
            {useCases.map((u) => (
      ...
      <section className="bg-[#111111] border-y border-[#2E2E2E] py-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 mb-10">
            {[
              { label: 'Existing equity', detail: 'The line is secured by portfolio equity. The more you have built, the more capital is available to you.' },
              ...
              { label: 'Long-term hold strategy', detail: 'Investors who plan to hold properties and build passive income use the line to grow without disrupting existing loans.' },
