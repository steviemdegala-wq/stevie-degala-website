      ...
      <section className="bg-[#111111] border-y border-[#2E2E2E] py-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {cards.map((card) => (
              <div key={card.title} className="card-hover border border-white/40 bg-white/90 backdrop-blur-sm p-8">
                <h3
      ...
      <section className="bg-[#0A0A0A] py-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-px bg-[#E0E0E0]">
            {steps.map((step) => (
              <div key={step.num} className="bg-white/90 backdrop-blur-sm p-8">
