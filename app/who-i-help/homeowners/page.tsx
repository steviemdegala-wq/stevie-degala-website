...
export const metadata: Metadata = {
  ...
  description: 'First-time home loans, refinancing, and cash-out refinance in Texas, Colorado, and Utah. I shop dozens of lenders so you get the best rate available.',
}

const cards = [
  {
    title: 'Buying your first home',
    body: 'First-time buyers in Texas, Colorado, and Utah get a broker who walks you through every step in plain English. No jargon, no pressure, no surprises at closing.',
  },
  {
