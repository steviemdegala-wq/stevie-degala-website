        ...
        <div className="max-w-4xl mx-auto">
          ...
          {rate30 || rate15 ? (
            <>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-12">
                {[
                  ...
                  <a
                    ...
                    className="bg-[#F8F8F8] border border-[#E0E0E0] rounded-2xl p-8 flex flex-col gap-4 hover:bg-[#EFEFEF] transition-colors"
              ...
              {/* 52-week chart */}
              {chartData.length > 0 && (
                <div className="bg-[#F8F8F8] border border-[#E0E0E0] rounded-2xl p-6 md:p-8">
