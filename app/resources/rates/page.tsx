...
export const metadata: Metadata = {
  ...
  description: 'Current conventional mortgage rate estimates for Texas, Colorado, and Utah.',
}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          {rate30 || rate15 ? (
            <>
              ...
              {/* 52-week chart */}
              {chartData.length > 0 && (
                <div className="bg-[#111111] border border-[#2E2E2E] rounded-2xl p-6 md:p-8">
